...
https://www.youtube.com/watch?v=ifI7ZhKp4rc&list=PLjPKPFvkBtZqKg8ugYihcxkWfnIDcwR4K&index=17
1:30
...
class Ui_MainWindow(object):
    ...
    def loadImage(self):
        ...
        if cam:
            ...
            video_file = self.readImagePath() + vid_name01  # Create path to the video
    ...
    def loadImage2(self):
        ...
        if cam:
            ...
            video_file = self.readImagePath() + vid_name02  # Create path to the video
            vid = cv2.VideoCapture(video_file)
