...
cv2.imshow("ORIGINAL DFT/IFT ROUND TRIP", img_back)#inverse FFT
cv2.imshow("FILTERED DFT/IFT ROUND TRIP", img_filtered) #inverse FFT with mask
cv2.imshow("FILTERED2 DFT/IFT ROUND TRIP", img_filtered2)##inverse FFT with mask and gussian
