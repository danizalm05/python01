...
thresholds = threshold_multiotsu(img, classes=4)#np array[val1,val2,val3]
...
all_segments_cleaned[segm4_closed] = (1,1,1)
...
ax4.imshow(regions, cmap='gray')
ax4.title.set_text(' multi-Otsu threshold ')


ax5 = fig.add_subplot(3,3,5)
ax5.imshow(all_segments_cleaned, cmap='gray')
