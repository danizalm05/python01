...
keybrd = kb.KeyBoard(keyboard_keys, 'final_text' )# Initialize the virtual keyboard
...
with mp_face_mesh.FaceMesh(
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            # blink eye
            dl = mesh_points[145][1] - mesh_points[159][1]
            dr = mesh_points[374][1] - mesh_points[385][1]
