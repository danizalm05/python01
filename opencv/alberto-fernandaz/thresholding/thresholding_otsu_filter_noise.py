"""
 thresholding_otsu_filter_noise.py
...
img_name =  "leaf-noise.png"#'leaf.png'
#'sudoku.png' # "p1.jpg"  "lena.png"     # "modrain.jpg"#"grains.jpg" #
...
# Plot all the images:
show_img_with_matplotlib(image,path, 1)
