...
Mastering-OpenCV-4-with-Python Chapter05 page 157
...
path = BASE_FOLDER
print(path)
# Name of test images 'test1.png', 'test2.png', 'test3.png'
...
def load_all_test_images():
    ...
    test_morph_images = []
    #enumerate(image_names)=[(0,'test1.png'),(1,'test2.png'),(2,'test3.png')]
...
#Creates the specific kernel to be used when performing the morphological
# operations
