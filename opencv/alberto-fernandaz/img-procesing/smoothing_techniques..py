...
# The function cv2.filter2D() applies an arbitrary linear filter to the
# provided image:
...
# The function cv2.GaussianBlur() convolves the source image with the specified
# Gaussian kernel
...
# The function cv2.bilateralFilter() can be applied to the input image in order
# to apply a bilateral filter:
