...
cv2.createTrackbar("Hue Min",winName,9,255,empty)
cv2.createTrackbar("Hue Max",winName,24,179,empty)
cv2.createTrackbar("Sat Min",winName,30,255,empty)
cv2.createTrackbar("Sat Max",winName,240,255,empty)
cv2.createTrackbar("Val Min",winName,175,255,empty)
cv2.createTrackbar("Val Max",winName,250,255,empty)
